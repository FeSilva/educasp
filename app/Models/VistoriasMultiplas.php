...
class VistoriasMultiplas extends Model
{
    ...
    protected $fillable = ['user_id', 'pi_id', 'tipo_id','predio_id', 'programa','fiscal_user_id', 'codigo_predio','dt_vistoria','num_orcamento','arquivo','name_archive','status','check_avanco','merge','cod_pi'];
