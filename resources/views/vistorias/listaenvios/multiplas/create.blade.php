            ...
            @component('components._card', [
                ...
                @slot('body')
                    ...
                    @component('components._form', [
                        ...
                        @slot('slot')
                            <span style="position: absolute;margin: 5px;top: 42px;" id="vistoriaDisponivel"> Vistorias Disponiveis: {{$qtdAprovadas}}</span>
...
@push('scripts')
    <script>
        ...
        function ChangeTipoVistoria(){
            $("#mes").val('Escolha o Mês');
            $("#codigo").val(' ');
        ...
        function  consultaListaMes(mes){
            var tipoVistoria = $("#tipoVistoria").val();
            $.ajax({
                headers: {
                    'X-CSRF-Token': $('input[name="_token"]').val()
                },
                type: 'post',
                url: '{{route('listaenviosMultiplos.consultaMes')}}',
                data: {'mes':mes,'tipoVistoria':tipoVistoria},
        ...
        function listarEnvios() {
            ...
            $.ajax({
                ...
                data: {tipo_vistoria:tipoVistoria},
                success: function (data) {
                    ...
                    if (data[0]) {
                        ...
                        $('#largeModal').hide();
                        $("#vistoriaDisponivel").html('Vistorias Disponiveis:' + data.qtyVistoria);
                        checkAllcheckbox();
                    } else {
                        $('#largeModal').hide();
