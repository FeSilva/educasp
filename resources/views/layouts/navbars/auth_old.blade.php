    ...
    <div class="sidebar-wrapper">
        ...
        <ul class="nav">
            ...
            <li class="{{ $elementActive == 'relatorios' ? 'active' : '' }}">
                <a data-toggle="collapse" aria-expanded="false" href="#relatorios">
                    <i class="nc-icon nc-paper"></i>
                    <p>Relatórios Gerênciais<b class="caret"></b></p>
                </a>
                <div class="collapse {{ $elementActive == 'relatorios' ? 'show' : '' }}" id="relatorios">
                    <ul class="nav">
                        <li class="{{ $elementActive == 'relatorios' ? 'active' : '' }}">
                            <a href="{{ route('relatory.supervisor.index') }}">
